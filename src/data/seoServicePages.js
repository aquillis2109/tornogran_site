export const seoServicePages = {
  '/usinagem-pesada': {
    ...
    topics: [
      'Torneamento, fresamento, ajustes e recuperação dimensional',
      'Peças sob medida por desenho, amostra ou necessidade de campo',
      'Componentes para mineração, máquinas pesadas e linhas produtivas',
      'Controle de medidas, tolerâncias e acabamento funcional',
    ],
    faq: [
      {
      ...
      {
        question: 'É possível fabricar peça por desenho ou amostra?',
        answer:
          'Sim. A TORNOGRAN pode avaliar desenho técnico, amostra, fotos e medidas para fabricação ou recuperação sob demanda.',
      },
      {
        question: 'Quais informações ajudam no orçamento de usinagem pesada?',
        answer:
          'Medidas, material, aplicação, fotos, desenho técnico, urgência e condição atual da peça ajudam a tornar o orçamento mais preciso.',
      },
    ],
  },
  '/recuperacao-industrial': {
    ...
    topics: [
      ...
      'Recomposição por soldagem e acabamento técnico',
      'Usinagem para ajuste dimensional',
      'Atendimento a equipamentos de mineração e máquinas pesadas',
    ],
    faq: [
      {
        question: 'Quando vale recuperar um componente industrial?',
        answer:
          'A recuperação pode ser indicada quando o componente ainda possui estrutura aproveitável e o reparo oferece melhor custo, prazo ou disponibilidade que a substituição.',
      },
      {
        question: 'A recuperação reduz paradas de equipamento?',
        answer:
          'Sim. Em muitos casos, recuperar o componente acelera o retorno da operação e reduz o impacto de paradas não planejadas.',
      },
      {
        question: 'Quais setores utilizam recuperação industrial?',
        answer:
          'Mineração, máquinas pesadas, indústrias, hidrelétricas e operações com alto desgaste mecânico utilizam esse tipo de serviço.',
      },
    ],
  },
  '/hardox': {
    ...
    topics: [
      'Caçambas, chutes, tremonhas e revestimentos',
      'Componentes expostos a abrasão e impacto',
      'Peças sob demanda para mineração',
      'Aplicações antidesgaste de alta durabilidade',
    ],
    faq: [
      {
        question: 'O que é Hardox?',
        answer:
          'Hardox é um aço antidesgaste usado em aplicações que exigem resistência a abrasão, impacto e ciclos severos de operação.',
      },
      {
        question: 'Onde o Hardox é usado na mineração?',
        answer:
          'É usado em caçambas, chutes, tremonhas, revestimentos, proteções e componentes sujeitos a desgaste intenso.',
      },
      {
        question: 'A TORNOGRAN trabalha com Hardox Wearparts?',
        answer:
          'Sim. A TORNOGRAN participa do programa Hardox Wearparts e atua com soluções antidesgaste para operações industriais.',
      },
    ],
  },
  '/caldeiraria-industrial': {
    ...
    topics: [
      'Fabricação e recuperação de estruturas metálicas',
      'Soldagem industrial aplicada a componentes robustos',
      'Reforços, adaptações e reparos sob demanda',
      'Atendimento a mineração e indústria pesada',
    ],
    faq: [
      {
        question: 'O que inclui caldeiraria industrial?',
        answer:
          'Inclui fabricação, montagem, recuperação, reforço e reparo de estruturas e componentes metálicos industriais.',
      },
      {
        question: 'A caldeiraria pode ser feita sob medida?',
        answer:
  ...
  '/fabricacao-sob-desenho': {
    ...
    topics: [
      'Fabricação por desenho técnico ou amostra',
      'Peças especiais para mineração e máquinas pesadas',
      'Engenharia reversa e adaptação de componentes',
      'Soluções para reposição, reforço e melhoria operacional',
    ],
    faq: [
      {
        question: 'É possível fabricar uma peça sem desenho técnico?',
        answer:
          'Sim. Dependendo do caso, a TORNOGRAN pode avaliar amostra, medidas, fotos e aplicação para desenvolver a solução.',
      },
      {
        question: 'Quais peças podem ser fabricadas sob desenho?',
        answer:
          'Peças industriais especiais, componentes de máquinas pesadas, partes mecânicas, estruturas e itens para mineração.',
      },
      {
        question: 'O orçamento depende de quais informações?',
        answer:
          'Material, medidas, desenho, aplicação, quantidade, prazo e condição de operação influenciam o orçamento.',
      },
    ],
  },
};

export const seoServiceRoutes = Object.keys(seoServicePages);
